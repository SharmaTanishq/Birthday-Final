          ...
          <div className = "timeline">
            <div className = "timeline-item" data-text = "FATHE OF THE TURKS">
              <div className = "timeline-content">
                <img className = "timeline-img" alt = "demo" src = "http://gazetemanifesto.com/wp-content/uploads/2015/11/mustafa-kemal.jpg"/>
        ...
        <path id="Path_35" data-name="Path 35" d="M51.779,72.829h-.121c-.243,0-.729-.03-1.305-.091-3.248-.395-7.529-.789-10.99-.941-1.123-.061-2.064-.121-2.095-.121,0,0-.88-2.55-2.55-7.316-1.609-4.645-3.977-11.445-7.043-20.279l-1.123-3.218L12.374,0H26.491L27.1,1.73l2.672,7.681Z" transform="translate(-12.374)" fill="#df0d12"/>
                ...
                <div className = "content-holder">
                    <div className = "about-card-wrapper">
                        <div className = "card" data-aos="fade-up"  ><img alt = "demo" src = {friends}></img></div>
                        <div className = "card" data-aos="fade-up" data-aos-delay = "50"><img alt = "demo" src = {friends}></img></div>
                        <div className = "card" data-aos="fade-up" data-aos-delay = "100"><img alt = "demo" src = {friends}></img></div>
                        <div className = "card" data-aos="fade-up" data-aos-delay = "150"><img alt = "demo" src = {friends}></img></div>
                        <div className = "card"data-aos="fade-up"><img alt = "demo" src = {friends}></img></div>
                    </div>
                </div>
            </section>
                ...
                <div className = "content-holder">
                    <div className = "song-card-wrapper">
                        <div className = "card-song"  >
                            <div className = "coverContainer"><img alt = "demo" src ={afterHours}></img></div>
            ...
            <div className = "info-holder">
                        <div className = "iconImg"><img alt = "demo" className = "maps" src = {Maps}></img></div>
                        <div>
